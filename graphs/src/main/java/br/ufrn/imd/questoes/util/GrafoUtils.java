...
public class GrafoUtils {
    ...
    static {
        ...
        listaDigrafoComPesos.put(2,
                Arrays.asList(new HashMap<>(Map.of(3, 2)), new HashMap<>(Map.of(6, 1)), new HashMap<>(Map.of(7, 10))));
        listaDigrafoComPesos.put(3,
                Arrays.asList(new HashMap<>(Map.of(8, 9)), new HashMap<>(Map.of(9, 7)), new HashMap<>(Map.of(12, 15))));
        ...
        listaDigrafoComPesos.put(6,
                Arrays.asList(new HashMap<>(Map.of(0, 2)), new HashMap<>(Map.of(2, 8)), new HashMap<>(Map.of(5, 7))));
        ...
        listaDigrafoComPesos.put(9,
                Arrays.asList(new HashMap<>(Map.of(4, 5)), new HashMap<>(Map.of(13, 6)), new HashMap<>(Map.of(14, 9))));
    ...
    public static Map<Integer, List<Map<Integer, Integer>>> getListaDigrafoComPesos() {
        return listaDigrafoComPesos;
    }
}
